...
<form:form method="post" action="/SpringMVCDemo/employee.html" modelAttribute="employee">
...
<table class="table table-bordered" style="width: 500px">
    ...
    <c:forEach items="${employeeList}" var="employee">
        ...
        <tr>
            ...
            <td width="100" align="center">${employee.name}</td>
            <td width="60" align="center">${employee.age}</td>
            <td width="60" align="center">${employee.dept}</td>
            <td width="80" align="center"><a href="edit/${employee.id}">Edit</a> | <a href="delete/${employee.id}">Delete</a>
            </td>
        </tr>
    </c:forEach>
</table>
